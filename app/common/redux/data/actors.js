...
export const createMovie = (body, options) =>
  invoke({
    endpoint: createUrl(`${API_URL}/actors`, options),
    method: 'POST',
    headers: {
...
export const updateActor = (actorId, body, options) =>
  invoke({
    endpoint: createUrl(`${API_URL}/actors/${actorId}`, options),
    method: 'PUT',
    headers: {
...
export const deleteActor = (actorId, options) =>
  invoke({
    endpoint: createUrl(`${API_URL}/actors/${actorId}`, options),
    method: 'DELETE',
    headers: {
